export const shipping = [
  ...
  },
  {
    ...
    answer: `If your order just shipped out it will typically take between 24-72 hours during business days (Monday-Friday) before you see updates.\nIf your order was showing tracking updates and stops showing them. Wait until it has been your anticipated shipping time, then please reach out to us and we’ll get that taken care of for you. \nFor international orders, if the last updates shows ‘Processing Completed At Origin’ it typically it takes a few business days to update as arrived in your country. It can take up to 2 weeks before scanning in as arrived in your country. If you any concerns, let us know and we can take a look at what we have seen lately for your country.`,
  },
  {
    question: `My package shows as delivered but it's not here. What can I do?`,
    answer: `I'm so sorry to hear that your order has been marked as delivered but hasn't shown up quite yet. Try to not stress out too much quite yet, this has happened a few times in the past. If your order doesn't show up after 72 hours of being marked as delivered, please don't hesitate to reach out and we'd be happy to help.\nHere's some super helpful steps we've used in the past to track down a missing package:\nChecking with anyone who has access to your mailbox. Check with your normal postal delivery person. My last recommendation would be to check with your neighbors. From time to time addresses are misread and neighbors receive mail and sometimes don't even realize it.`,
  },
  {
    question: `Will I have to pay customs/duties fees?`,
    answer: `If you selected 'Delivered Duties Paid' as your shipping method and are being charged a customs fee, please accept the package and reach out to us with an image of the customs receipt and we will refund you for any fees you were charged by applying it to a previous order or through providing a store credit.\nIf you choose to go with our 'Free Shipping - Duties May Be Due At Border' option and are charged a fee by your countries customs office, you can opt to have the package sent back to us for a refund or store credit minus the shipping fee to cover our costs to ship your order.`,
  },
  {
    question: `IMPORTANT International Addresses Must Be In English`,
    answer: `I'm so sorry but sadly at this point in time, our system is unable to read and print addresses that are input into the system in any other characters besides English. If you enter your address with other characters your package will not be able to be delivered and will have to be reshipped or potentially refunded.`,
  },
  {
